...
export default class DemoBabylon {
  ...
  runDemoSimpleWorld(engine) {
    ...
    // BABYLON.SceneLoader.ImportMeshAsync(['AnimatedMorphCube'], 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/AnimatedMorphCube/glTF-Binary/', "AnimatedMorphCube.glb", scene);
...
runDemoKgAvatar(engine) {
  ...
  // Append glTF model to scene.
  BABYLON.SceneLoader.Append("https://d3g.qq.com/musicapp/kge/22406/", "daji2.glb", scene, function (scene) {
      // Create a default arc rotate camera and light.
      scene.createDefaultCameraOrLight(true, true, true);
  ...
  run() {
    BABYLON.Engine.ExceptionList.push({
      key: '.*',
      capture: null,
